...
interface RemoteDataSource {
    ...
    fun deleteCategory(idWrapper: IdWrapper): Flow<Response<Boolean>>
    ...
    fun deletePeriod(idWrapper: IdWrapper): Flow<Response<Boolean>>
    ...
    fun deleteBudgetTransaction(idWrapper: IdWrapper): Flow<Response<Boolean>>
}