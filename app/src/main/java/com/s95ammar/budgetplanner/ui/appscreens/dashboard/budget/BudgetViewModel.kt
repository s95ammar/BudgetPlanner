...
class BudgetViewModel @ViewModelInject constructor(
    ...
    fun onNavigateToPeriodRecords() {
        ...
        _performUiEvent.call(BudgetUiEvent.OnNavigateToPeriodRecords(PeriodRecordsNavigationBundle(existingCategoryIds, periodId)))
    }
    ...
    private fun loadPeriodRecords() {
        ...
        viewModelScope.launch {
            remoteRepository.getPeriodRecordsForPeriod(periodId)
                ...
                .onError { _performUiEvent.call(BudgetUiEvent.DisplayLoadingState(LoadingState.Error(it))) }
        }
    }
}